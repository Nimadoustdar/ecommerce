    ...
    <div>
      ...
      <div className="p-3">
        ...
        <div className="flex items-center justify-between mt-4 mobile:flex-col">
          <button className="btn bg-white text-[#8a4af3] border-2 border-[#8a4af3] mt-0 hover:text-white hover:border-white">
            Continue Shopping
          </button>
              ...
              <div className=" product flex pl-5 self-start">
                ...
                <div className="disc flex items-start justify-between h-auto flex-col ml-6">
                  ...
                  <p className="flex items-center justify-center">
                    ...
                    <div className="colorSelect bg-slate-600-500 ml-1 w-[20px] h-[20px]"></div>
                  </p>
                  <p>
