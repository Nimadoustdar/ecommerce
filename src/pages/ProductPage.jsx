...
const ProductPage = () => {
  return (
    <div>
      <Announce/>
      <Navbar />
      <div className="flex justify-center mb-5 mobile:flex-col mobile:mt-4 mobile:p-3">
        ...
        <div className="flex-[1.3] flex flex-col items-start  justify-items-center mt-10 mobile:items-center">
          ...
          <div className="flex flex-col place-self-start">
            ...
            <div className="colors flex mt-7 text-2xl">
              Colors
              <div className="colorSelect w-[2rem] h-[2rem] rounded-full p-[10px] cursor-pointer border-2 ml-5 bg-red-600 "></div>
              <div className="colorSelect w-[2rem] h-[2rem] rounded-full p-[10px] cursor-pointer border-2 ml-5 bg-blue-600 "></div>
              <div className="colorSelect w-[2rem] h-[2rem] rounded-full p-[10px] cursor-pointer border-2 ml-5 bg-yellow-400 "></div>
            </div>
